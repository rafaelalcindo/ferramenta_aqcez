$(document).ready(function(){
            ...
            $('#btn_finish').click(function(){
                ...
                var tipo_reforma  = $('#sele_tipo_reforma').val();
               ...
               // var file_upload   = verificaUpload($('#upload_image').val());
                ...
                if(escritorio.trim() != ''){
                                            ...
                                            if(email.trim() != ''){
                                                if(estado.trim() != ''){
                                                    if(cidade.trim != ''){
                                                        ...
                                                        data.append('tipo_reforma', tipo_reforma);
                  ...
                  }else{ alert('Por favor selecione o tipo de Reforma.'); }
                    ...
                    $.getJSON("json_file/construcao.json",function(data){
                        $.each(data, function(key, val){
                            ...
                            if(key == segmento){                            
                                ...
                                $('#u255138').attr('style','background: #DCDCDC');
                            }
