...
function sendEmail($soliObj){
	...
	$tipo_orc = isset($_REQUEST['tipo_orc'])? $_REQUEST['tipo_orc'] : null;

	if($tipo_orc == 'projetos'){
		$titulo = 'Pedido de Orçamento de Projetos!';
	}else if($tipo_orc == 'outros'){
		$titulo = 'Pedido de Orçamento de outros!';
	}else{
